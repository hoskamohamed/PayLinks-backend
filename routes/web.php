...
Route::controller(SiteController::class)->group(function(){
    ...
    Route::post("callback/payment-link/response/{gateway}",'callback')->name('payment.callback')->withoutMiddleware(['web']);
...
Route::controller(InvoiceController::class)->prefix('/invoice')->name('invoice.')->group(function(){
    ...
    Route::prefix('payment')->name('payment.')->group(function(){
        ...
        Route::get('redirect/btn/checkout/{gateway}', 'redirectBtnPay')->name('payment.btn.pay')->withoutMiddleware(['auth']);
