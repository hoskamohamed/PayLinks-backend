...
use App\Http\Controllers\Admin\WebJornalController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(InvoiceController::class)->prefix('invoice')->name('invoice.')->group(function () {
        ...
        Route::get('paid-invoice', 'paidInvoice')->name('paid.invoice');
        Route::get('unpaid-invoice', 'unpaidInvoice')->name('unpaid.invoice');
        Route::get('draft-invoice', 'draftInvoice')->name('draft.invoice');
    ...
    Route::controller(SetupSmsController::class)->prefix('setup-sms')->name('setup.sms.')->group(function () {
        Route::get('config', 'configuration')->name('config');
        Route::put('config/update', 'update')->name('config.update');
        Route::post('test-sms/send','sendTestSMS')->name('test.sms.send');
    });
    ...
    Route::controller(SetupSectionsController::class)->prefix('setup-sections')->name('setup.sections.')->group(function () {
        ...
        // Event
        Route::controller(WebJornalController::class)->prefix('web-jornal')->name('web-jornal.')->group(function(){
            Route::get('index', 'index')->name('index');
            Route::post('store', 'store')->name('store');
