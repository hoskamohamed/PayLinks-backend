    ...
    @forelse ($transactions as $item)
        <div class="dashboard-list-item-wrapper">
                ...
                <div class="dashboard-list-left">
                    <div class="dashboard-list-user-wrapper">
                        ...
                        <div class="dashboard-list-user-content">
                            @if ($item->type == payment_gateway_const()::TYPEPAYLINK || $item->type == payment_gateway_const()::TYPEINVOICE)
            ...
            <div class="preview-list-wrapper">
                ...
                @if ($item->type == payment_gateway_const()::TYPEPAYLINK || $item->type == payment_gateway_const()::TYPEINVOICE || $item->type == payment_gateway_const()::TYPEADDSUBTRACTBALANCE)
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                            <div class="preview-list-user-wrapper">
                                <div class="preview-list-user-icon">
