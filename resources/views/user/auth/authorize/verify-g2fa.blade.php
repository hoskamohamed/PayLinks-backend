        ...
        <div class="account-form-area text-center">
            ...
            <form method="POST" class="account-form" action="{{ setRoute('user.authorize.google.2fa.submit') }}">
                ...
                <div class="row ml-b-20">
                    ...
                    <div class="col-lg-12 form-group text-center">
                        <button type="submit" class="btn--base w-100 btn-loading">Verify 2FA</button>
                    </div>
                    <div class="col-lg-12 text-center">
                        <div class="account-item">
                            <label>{{ __('Already Have An Account?') }} <a href="{{ setRoute('global.login') }}" class="account-control-btn">{{ __('Login
                                Now') }}</a></label>
                        </div>
                    </div>
                </div>
