...
<div class="account-section ptb-80">
    ...
    <div class="account-area">
        <div class="account-form-area">
            <h5 class="title">{{ @$login->value->language->$defualt_lang->heading }}</h5>
            <p>{{ @$login->value->language->$defualt_lang->sub_heading }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="account-item">
                            <label>{{ __("Don't Have An Account?") }} <a href="{{ setRoute('user.register') }}">{{ __('Register') }}</a></label>
                        </div>
                    </div>
                    <div class="col-lg-12 text-center">
