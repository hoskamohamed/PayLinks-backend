...
<div class="account-section ptb-80">
    ...
    <div class="account-area">
        <div class="account-form-area">
            ...
            <p>{{ _('Take control of your account by resetting your password. Our password recovery page guides you through the necessary steps to securely reset your password') }}</p>
            <form class="account-form" action="{{ setRoute('user.password.forgot.send.code') }}" method="POST">
                @csrf
                <div class="row ml-b-20">
                    <div class="col-lg-12 form-group">
                        <input type="email" class="form--control" placeholder="Enter Email" name="credentials" required>
                    </div>
