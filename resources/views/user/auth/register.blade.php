...
<div class="account-section ptb-80">
    <div class="account-area">
        <div class="account-form-area">
            <h5 class="title">{{ @$register->value->language->$defualt_lang->heading }}</h5>
            <p>{{ @$register->value->language->$defualt_lang->sub_heading }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="account-item">
                            <label>{{ __('Already Have An Account?') }} <a href="{{ setRoute('user.login') }}" class="account-control-btn text--base" data-block="login">{{ __('Login
                                Now') }}</a> -</label>
                        </div>
                    </div>
                </div>
