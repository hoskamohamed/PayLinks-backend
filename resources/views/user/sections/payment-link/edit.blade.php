    ...
    <div class="custom-card payment-card">
        <div class="payment-type-wrapper">
            ...
            <form action="{{ setRoute('user.payment-link.update') }}" class="payment-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="payment-box payment-box-area" id="pay-view">
                    ...
                    <div class="payment-check-group">
                        <div class="custom-check-group">
                            ...
                            <label for="level-1">Set limits</label>
                        </div>
                ...
                <button type="submit" class="btn--base mt-20 active w-100 btn-loading">{{ __('Update Link') }}</button>
            </form>
        </div>
            ...
            <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="payment-preview-mockup">
                        ...
                        <div class="payment-preview-box two">
                            <div class="payment-preview-box-left">
                                <h3 class="sub-title "><i class="lab la-windows"></i> <span class="link-sub-title">{{ Auth::user()->address->company_name ?? '' }}</span> <span class="paylink_qty">({{ $payment_link->qty }})</span></h3>
                                        ...
                                        <div class="col-xl-12 form-group">
                                            <div class="preview-check-group">
                                                <div class="custom-check-group">
                                                    ...
                                                    <label for="level-2">{{ __('Securely save my inforation for 1-click checkout') }} <span>Pay faster on {{ Auth::user()->address->company_name ?? '' }} and everywhere Link is accepted</span></label>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="tab-pane fade show active" id="web" role="tabpanel" aria-labelledby="web-tab">
                    <div class="payment-preview-box">
                        <div class="payment-preview-box-left">
                            <span class="sub-title"><i class="lab la-windows"></i> <span class="link-sub-title">{{ Auth::user()->address->company_name ?? '' }}</span> <span class="paylink_qty">({{ $payment_link->qty }})</span></span>
                            <form class="payment-preview-box-left-form">
                                <div class="form-group">
                        ...
                        <div class="payment-preview-box-right">
                            <form class="payment-preview-box-right-form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 form-group pt-10">
                                        <button type="submit" class="btn--base disabled active w-100" disabled>{{ _('Pay') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
