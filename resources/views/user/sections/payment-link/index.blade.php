                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="action-btn ms-1">
                                            ...
                                            <ul class="action-list">
                                                @if ($item->status == 1)
                                                    <li><a href="{{ setRoute('user.payment-link.edit', $item->id) }}">Edit</a></li>
                                                @endif
                                                @if ($item->status == 1)
                                                    <li><a href="" class="status_change" data-target="{{ $item->id }}" data-type="Close">Close</a></li>
                                                @else
                                                    <li><a href="" class="status_change" data-target="{{ $item->id }}" data-type="Active">Active</a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
