                    ...
                    <div class="col-xl-12 form-group">
                        ...
                        <select class="select2-auto-tokenize currency_link w-100" name="currency">
                            ...
                            @foreach ($currency_data as $item)
                                <option value="{{ $item->code }}" data-country="{{ $item->name }}" data-currency_name="{{ $item->name }}" data-currency_code="{{ $item->code }}" data-currency_symbol="{{ $item->symbol }}" {{ $item->currency_code == $invoice->currency_code ? 'selected' : '' }}>{{ $item->code. ' ('. $item->name.')' }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
