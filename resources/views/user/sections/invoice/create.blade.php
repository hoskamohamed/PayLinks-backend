            ...
            <div class="payment-invoice-form">
                ...
                <div class="row">
                    <div class="col-xl-12 form-group">
                        ...
                        <input type="text" class="form--control" value="{{ Auth::user()->address->company_name ?? '' }}" name="title" required placeholder="Title">
                    </div>
                    <div class="col-xl-12 form-group">
                        <label>{{ __('Name') }}*</label>
                        <input type="text" class="form--control" value="{{ Auth::user()->fullname ?? '' }}" name="name" required placeholder="Name">
                    </div>
                    <div class="col-xl-12 form-group">
                        <label>{{ __('Customer Email') }}*</label>
                        <input type="email" class="form--control" value="" name="email" required placeholder="Customer Email">
                    </div>
                    <div class="col-xl-12 form-group">
                        <label>{{ __('Phone') }}*</label>
                        <input type="number" class="form--control" value="{{ Auth::user()->mobile ?? '' }}" name="phone" required placeholder="Phone">
                    </div>
                    <div class="col-xl-12 form-group">
            ...
            <div class="payment-invoice-items-form">
                ...
                <div class="row add-row-wrapper align-items-end mt-20">
                    <div class="col-xl-4 col-lg-5 col-md-5 form-group">
                        <label>{{ __('Title') }}*</label>
                        <input type="text" class="form--control item_title" name="item_title[]" value="Collecting Payment Platform" required>
                    </div>
            ...
            <div class="payment-invoice-box">
                ...
                <div class="payment-invoice-box-list-wrapper">
                    <ul class="payment-invoice-box-list">
                        ...
                        <li class="phone">{{ Auth::user()->pho }}</li>
                    </ul>
                    <ul class="payment-invoice-box-list">
