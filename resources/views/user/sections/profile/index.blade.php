                            ...
                            <div class="profile-form-area">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <input type="text" class="form--control" placeholder="Enter Name..." required name="first_name" value="{{ old('first_name', $user->firstname ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>Last Name<span>*</span></label>
                                        <input type="text" class="form--control" placeholder="Enter Name..." required name="last_name" value="{{ old('last_name', $user->lastname ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>Country</label>
                                    ...
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>Mobile</label>
                                        <input type="number" class="form--control" placeholder="Enter Number..." name="mobile" value="{{ old('mobile', $user->mobile ?? '') }}">
                                    </div>
                                    <div class="col-xl-12 col-lg-12 form-group">
                                        <label>Company Name</label>
                                        <input type="text" class="form--control" placeholder="Enter Company Name..." name="company_name" value="{{ old('company_name', $user->address->company_name ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>Address</label>
                                        <input type="text" class="form--control" placeholder="Enter Address..." name="address" value="{{ old('address', $user->address->address ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>City</label>
                                        <input type="text" class="form--control" placeholder="Enter City..." name="city" value="{{ old('city', $user->address->city ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>State</label>
                                        <input type="text" class="form--control" placeholder="Enter State..." name="state" value="{{ old('state', $user->address->state ?? '') }}">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>Zip Code</label>
                                        <input type="number" class="form--control" placeholder="Enter Zip..." name="zip_code" value="{{ old('zip_code', $user->address->zip_code ?? '') }}">
                                    </div>
                                </div>
                        ...
                        <form class="card-form" method="POST" action="{{ setRoute('user.profile.password.update') }}">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 form-group show_hide_password">
                                    ...
                                    <input type="password" class="form--control" placeholder="Enter Password..." name="current_password" required>
