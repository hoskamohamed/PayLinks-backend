    ...
    <div class="four-not-four-section">
        <div class="four-not-four-wrapper">
            <div class="four-not-four-thumb">
                ...
                <img src="{{ asset("error-images/404_not_found.png") }}" alt="404" class="error-bg">
                ...
                <div class="four-not-four-element-two">
                    <img src="{{ asset("error-images/4.png") }}" alt="four">
                </div>
            ...
            <div class="four-not-four-content">
                <h1 class="title">{{ __("Page Not Found...!") }}</h1>
                <div class="four-not-four-btn">
                    <a href="{{ route('index') }}" class="btn--base">{{ __("Back To Home") }}</a>
                </div>
            </div>
        </div>
    </div>
