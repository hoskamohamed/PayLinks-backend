...
@section("content")
    <div class="four-not-four-section">
        <div class="four-not-four-wrapper">
            ...
            <img src="{{ asset("error-images/419.png") }}" alt="419" class="error">
            <img src="{{ asset("error-images/419-(Page-Expired).png") }}" alt="419" class="error-bg">
                ...
                <div class="four-not-four-element-two">
                    <img src="{{ asset("error-images/9.png") }}" alt="nine">
                </div>
