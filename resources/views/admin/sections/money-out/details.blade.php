            ...
            <div class="row align-items-center mb-10-none">
                <div class="col-xl-4 col-lg-4 form-group">
                    ...
                    @endif
                        ...
                        <li class="four">Method: <span>{{ get_gateway_name(@$data->currency->payment_gateway_id) }}</span></li>
                        <li class="five">Request Amount: <span>{{ number_format(@$data->request_amount,2) }} {{ @$data->details->data->sender_currency->currency_code }}</span></li>
                    </ul>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list two">
                           <li class="one">Rate: <span>1 {{ @$data->details->data->sender_currency->currency_code }} = {{ number_format(@$data->details->data->gateway_rate,2) }} {{ @$data->currency->currency_code }}</span></li>
                           <li class="two">After Conversion: <span>{{ number_format(@$data->details->data->conversion_amount,2) }} {{ @$data->currency->currency_code }}</span></li>
                        <li class="three">Charge: <span>{{ number_format(@$data->details->data->gateway_charge,2) }} {{ @$data->currency->currency_code }}</span></li>

                        <li class="four">Will Get: <span>{{ number_format(@$data->details->data->will_get,2) }} {{ @$data->currency->currency_code }}</span></li>
