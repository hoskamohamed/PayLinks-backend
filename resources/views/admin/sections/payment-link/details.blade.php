                ...
                <div class="row align-items-center mb-10-none">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list two">
                            ...
                            <li class="four">Conversion Payable: <span>{{ get_amount(@$data->conversion_payable,@$data->details->charge_calculation->receiver_currency_code,4) }} {{@$item->details->charge_calculation->sender_cur_code }}</span></li>
