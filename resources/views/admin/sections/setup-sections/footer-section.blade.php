                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="form-group">
                                                @include('admin.components.form.textarea',[
                                                    'label'     => "About Details*",
                                                    'name'      => $default_lang_code . "_about_details",
                                                    'value'     => old($default_lang_code . "_about_details",$data->value->language->$default_lang_code->about_details ?? ""),
                                                    'data_limit' => 450,
                                                ])
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    @include('admin.components.form.textarea',[
                                                        'label'     => "About Details*",
                                                        'name'      => $lang_code. "_about_details",
                                                        'value'     => old($lang_code. "_about_details",$data->value->language->$default_lang_code->about_details ?? ""),
                                                        'data_limit' => 450,
                                                    ])
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    @include('admin.components.form.textarea',[
                                                        ...
                                                        'value'     => old($lang_code. "_newsltter_details",$data->value->language->$default_lang_code->newsltter_details ?? ""),
                                                        'data_limit' => 450,
                                                    ])
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_social_icon_edit]").val((oldData.language[item.code] == undefined) ? '' : oldData.language[item.code].social_icon);
