...
@section('content')
    ...
    @include('admin.components.modals.site-section.faq-add')

    {{-- Faq Item Edit Modal --}}
    <div id="faq-category-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("Edit Faq Category") }}</h5>
            </div>
...
@push('script')
    ...
    <script>
        ...
        openModalWhenError("faq-category-edit","#faq-category-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#faq-category-edit");
            ...
            openModalBySelector("#faq-category-edit");
