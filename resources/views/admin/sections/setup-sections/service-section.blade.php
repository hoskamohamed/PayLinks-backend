...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#service-section-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-service-section')

    {{--  Item Edit Modal --}}
    <div id="service-section-edit" class="mfp-hide large">
    ...
    <div id="service-veiw-modal" class="mfp-hide">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("View Service") }}</h5>
            </div>
            <div class="modal-form-data">
                <p class="view"></p>
            </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("service-section-add","#service-section-add");
        openModalWhenError("service-section-edit","#service-section-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#service-section-edit");
            ...
            fileHolderPreviewReInit("#service-section-edit input[name=image]");
            openModalBySelector("#service-section-edit");

        });

        $(".view-modal-button").click(function(){
            var oldData = JSON.parse($(this).parents("tr").attr("data-item"));
            var editModal = $("#service-veiw-modal");

            editModal.find(".view").text(oldData.language[default_language].details);

            openModalBySelector("#service-veiw-modal");
        });
