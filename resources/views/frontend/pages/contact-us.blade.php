            ...
            <div class="row justify-content-center align-items-center mb-30-none">
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="contact-widget-item-wrapper">
                        <div class="contact-header">
                            <h2 class="section-title">{{ @$contact_us->value->language->$default_lng->heading }}</h2>
                            <p>{{ @$contact_us->value->language->$default_lng->sub_heading }}</p>
                        </div>
                        <div class="contact-widget-item">
                            ...
                            <div class="contact-widget-content">
                                ...
                                <p>{{ @$contact_us->value->language->$default_lng->address }}</p>
                            </div>
                        </div>
                        <div class="contact-widget-item">
                            <div class="contact-widget-icon">
                            ...
                            <div class="contact-widget-content">
                                ...
                                <p>{{ @$contact_us->value->language->$default_lng->phone }}</p>
                            </div>
                        </div>
                        <div class="contact-widget-item">
                            <div class="contact-widget-icon">
                            ...
                            <div class="contact-widget-content">
                                ...
                                <p>{{ @$contact_us->value->language->$default_lng->email }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="contact-form-area">
                        <div class="contact-header">
                            <h5 class="title">{{ @$contact_us->value->language->$default_lng->heading_two }}</h5>
                            <p>{{ @$contact_us->value->language->$default_lng->sub_heading_two }}</p>
                        </div>
