        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8">
                <div class="about-content">
                    <h2 class="title">{{ @$about->value->language->$default_lng->heading }}</h2>
                    <p>{{ @$about->value->language->$default_lng->details }}</p>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6">
                <div class="section-header text-center">
                    <h2 class="section-title">{{ @$faq->value->language->$default_lng->heading }}</h2>
                    <p>{{ @$faq->value->language->$default_lng->sub_heading }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-6 col-lg-6 mb-30">
                    @if(isset($faq->value->items))
                        @foreach($faq->value->items ?? [] as $key => $item)
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">{{ $item->language->$default_lng->question }}</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>{{ $item->language->$default_lng->answer }}</p>
                                </div>
                            </div>
                        @endforeach
                    @endif
