    ...
    <div class="container">
            <div class="col-xl-5 col-lg-6 col-md-8 mb-30">
                <div class="banner-content">
                    <span class="sub-title">{{ @$home_banner->value->language->$default_lng->title }}
                    ...
                    <h1 class="title">{{ @$home_banner->value->language->$default_lng->heading }}</h1>
                    <p>{{ @$home_banner->value->language->$default_lng->sub_heading }}</p>
                    <div class="banner-btn">
                        <a href="{{ url('/') }}/{{ @$home_banner->value->primary_button_link }}" class="btn--base">{{ @$home_banner->value->language->$default_lng->primary_button_name }}
                            <svg class="HoverArrow" width="10" height="10" viewBox="0 0 10 10" aria-hidden="true">
                                <g fill-rule="evenodd">
                                    <path class="HoverArrow__linePath" d="M0 5h7"></path>
                                    <path class="HoverArrow__tipPath" d="M1 1l4 4-4 4"></path>
                        ...
                        <a href="{{ url('/') }}/{{ @$home_banner->value->secondary_button_link }}" class="btn--base active">{{ @$home_banner->value->language->$default_lng->secondary_button_name }}
                            <svg class="HoverArrow" width="10" height="10" viewBox="0 0 10 10" aria-hidden="true">
                                <g fill-rule="evenodd">
                                    <path class="HoverArrow__linePath" d="M0 5h7"></path>
                                    <path class="HoverArrow__tipPath" d="M1 1l4 4-4 4"></path>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <div class="section-header">
                    <h2 class="section-title">{{ @$security_section->value->language->$default_lng->heading }}</h2>
                    <p>{{ @$security_section->value->language->$default_lng->sub_heading }}</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="row justify-content-center align-items-center mb-30-none">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                                <div class="how-it-works-left-content">
                                    <h3 class="title">{{ @$item->language->$default_lng->title }}</h3>
                                    <p>{{ @$item->language->$default_lng->details }}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6">
                <div class="section-header text-center">
                    <h2 class="section-title">{{ @$testimonial->value->language->$default_lng->heading }}</h2>
                    <p>{{ @$testimonial->value->language->$default_lng->sub_heading }}</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-xl-7 col-lg-6 mb-30">
                                    <div class="testimonial-content">
                                        <div class="testimonial-user-wrapper">
                                            ...
                                            <h5 class="title">{{ @$item->language->$default_lng->name }}-</h5>
                                            <span class="sub-title">{{ @$item->language->$default_lng->designation }}</span>
                                            <div class="ratings">
                                                @for ($i = 0; $i < 5; $i++)
                                        ...
                                        <h4 class="title">{{ @$item->language->$default_lng->title }}</h4>
                                        <p>{{ @$item->language->$default_lng->details }}</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="app-content">
                        <span class="sub-title">{{ @$download->value->language->$default_lng->title }}</span>
                        <h2 class="title">{{ @$download->value->language->$default_lng->heading }}</h2>
                    <p>{{ @$download->value->language->$default_lng->sub_heading }}</p>
