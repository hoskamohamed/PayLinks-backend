                       ...
                       <div class="col-xl-12 form-group">
                        ...
                        <div class="col-xl-12 form-group">
                            <div class="preview-secure-group">
                                ...
                                <p>{{ __('Securely save my inforation for 1-click checkout') }} <span>{{ __('Pay faster on') }} {{ @$invoice->user->address->company_name }} {{ __('and everywhere Link is accepted') }}</span></p>
                            </div>
                        </div>
