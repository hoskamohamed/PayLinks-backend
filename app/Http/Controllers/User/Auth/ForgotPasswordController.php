...
class ForgotPasswordController extends Controller
{
    ...
    public function sendCode(Request $request)
    {
        ...
        return redirect()->route('user.password.forgot.code.verify.form',$token)->with(['success' => ['Password reset code sended to your email.']]);
    }
    ...
    public function resendCode($token)
    {
        ...
        return redirect()->route('user.password.forgot.code.verify.form',$token)->with(['success' => ['Password reset code resend success!']]);
