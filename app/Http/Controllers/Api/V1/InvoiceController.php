...
class InvoiceController extends Controller
{
    ...
    public function index(){
        ...
        return ApiResponse::success(['success' => ['Data Fetch Successful']], $data);
    }
     ...
     */
     ...
     public function delete(Request $request){
        ...
        if($invoice->status == 1){
            return ApiResponse::onlyError(['error' => ['You Can Not Delete Paid Invoice']]);
        }
        ...
        return ApiResponse::onlySuccess(['success' => ['Invoice Deleted Successful']]);
    }
