...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $profit_percent = (($today_money_out * 100) / $last_month_profit_p);
        ...
        $transaction_invoice_balance = Transaction::toBase()->where('type', PaymentGatewayConst::TYPEINVOICE)->sum('request_amount_admin');
        ...
        $transaction_payment_link_balance = Transaction::toBase()->where('type', PaymentGatewayConst::TYPEPAYLINK)->sum('request_amount_admin');
