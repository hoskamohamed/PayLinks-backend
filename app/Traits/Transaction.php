...
trait Transaction {
    ...
    public function createTransactionChargeRecord(int $transaction_id, $output) {
        ...
        try{
            ...
            DB::rollBack();
            return back()->with(['errors' => ['Something went wrong, Please Try Again!']]);
        }
        return true;
    }
    ...
    public function notification($output){
        ...
        try{
            $notification_content = [
                'title'         => "Payment Received Via " .$output['transaction_type'],
            ...
            $notification_message = [
                'title'   => $output['transaction_type'].' Transaction From', $output['receiver_wallet']->user->fullname,
                'time'      => Carbon::now()->diffForHumans(),
